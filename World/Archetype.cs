...
using XDTGame.Core;
using XDTLevelAndEntity.Core.World.Attributes;
...
public abstract class Archetype
{
    ...
    sealed class TypeWrap
    {
        ...
        public TypeWrap(Type type)
        {
            ...
            foreach (var attribute in type.GetCustomAttributes<ComponentDependenciesAttribute>())
            {
    ...
    {
        public static readonly ArchetypeInfo Default = new ArchetypeInfo(new List<TypeInfo>(), 0, ArchetypeId.Invalid);
    ...
    internal static bool HasAny<T1, T2, T3, T4, T5>(in ArchetypeId id)
    {
        ...
        ulong bloomFlag = type<T1>.BloomFlag | type<T2>.BloomFlag | type<T3>.BloomFlag | type<T4>.BloomFlag | type<T5>.BloomFlag;
        if((typeInfo.BloomFlag & bloomFlag) == 0) 
            return false;
...
public sealed class Archetype<T1, T2, T3, T4, T5> : Archetype
{
    ...
    static Archetype()
    {
        ...
        BloomFlag = type<T1>.BloomFlag | type<T2>.BloomFlag | type<T3>.BloomFlag | type<T4>.BloomFlag | type<T5>.BloomFlag;
        Id = Archetype.Register(ref Types, BloomFlag);
    }
}
...
public sealed class Archetype<T1, T2, T3, T4, T5, T6> : Archetype
{
    ...
    static Archetype()
    {
        ...
        BloomFlag = type<T1>.BloomFlag | type<T2>.BloomFlag | type<T3>.BloomFlag | type<T4>.BloomFlag | type<T5>.BloomFlag | type<T6>.BloomFlag;
        Id = Archetype.Register(ref Types, BloomFlag);
    }
}
